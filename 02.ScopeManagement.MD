...
<h2>Control Scope</h2>
It monitors the status of the project and product scope and manages change requests to the scope baseline.<br>
All change requests are processed through the Perform Integrated Change Control process to prevent scope creep.
